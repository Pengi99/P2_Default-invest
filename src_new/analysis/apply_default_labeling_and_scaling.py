...
# 부실 기업 정보 로드
value_fail = pd.read_csv('data_new/raw/value_fail.csv', dtype={'종목코드': str})
...
# 라벨링된 데이터 저장
fs_ratio_final.to_csv('data_new/final/FS_ratio_flow_labeled.csv', index=False, encoding='utf-8-sig')
print(f"✅ 라벨링된 데이터 저장: data_new/final/FS_ratio_flow_labeled.csv")
