...
def run_step(step_file, step_name):
    ...
    try:
        ...
        result = subprocess.run([sys.executable, f'src/data_processing/{step_file}'], 
                              capture_output=True, 
                              text=True, 
                              encoding='utf-8')
...
def main():
    ...
    if success_count == len(steps):
        ...
        print("📁 최종 결과: data/processed/FS_ratio_flow.csv")
        print("\n💡 주요 개선사항:")
        ...
        # 파일 크기 확인
        try:
            file_size = os.path.getsize('data/processed/FS_ratio_flow.csv') / 1024 / 1024
