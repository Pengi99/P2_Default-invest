...
class FinancialDataMerger:
    ...
    def __init__(self, primary_file: str, secondary_file: str):
        ...
        self.column_mapping = {
            ...
            # c_fs.csv와 i_fs.csv 기본 재무제표 항목 매핑 추가
            '유형자산(*)(IFRS연결)(천원)': '유형자산(*)(IFRS)(천원)',
            '무형자산(*)(IFRS연결)(천원)': '무형자산(*)(IFRS)(천원)',
            '재고자산(*)(IFRS연결)(천원)': '재고자산(*)(IFRS)(천원)',
            '현금및현금성자산(*)(IFRS연결)(천원)': '현금및현금성자산(*)(IFRS)(천원)',
            '비유동자산(*)(IFRS연결)(천원)': '비유동자산(*)(IFRS)(천원)',
            '비유동부채 (*)(IFRS연결)(천원)': '비유동부채 (*)(IFRS)(천원)',
            '장기차입금(*)(IFRS연결)(천원)': '장기차입금(*)(IFRS)(천원)',
            '단기차입금(*)(IFRS연결)(천원)': '단기차입금(*)(IFRS)(천원)',
            '매출채권(IFRS연결)(천원)': '매출채권(IFRS)(천원)',
            '매입채무(IFRS연결)(천원)': '매입채무(IFRS)(천원)',
            '선수수익(IFRS연결)(천원)': '선수수익(IFRS)(천원)',
            '기타유동부채(IFRS연결)(천원)': '기타유동부채(IFRS)(천원)',
            '기타유동자산(IFRS연결)(천원)': '기타유동자산(IFRS)(천원)',
            '(금융)리스부채(IFRS연결)(천원)': '(금융)리스부채(IFRS)(천원)',
            '단기금융상품(금융기관예치금)(IFRS연결)(천원)': '단기금융상품(금융기관예치금)(IFRS)(천원)',
            '기타포괄손익누계액(*)(IFRS연결)(천원)': '기타포괄손익누계액(*)(IFRS)(천원)',
            '매출원가(*)(IFRS연결)(천원)': '매출원가(*)(IFRS)(천원)',
            '매출총이익(손실)(IFRS연결)(천원)': '매출총이익(손실)(IFRS)(천원)',
            '계속영업이익(손실)(IFRS연결)(천원)': '계속영업이익(손실)(IFRS)(천원)',
            '이자비용(IFRS연결)(천원)': '이자비용(IFRS)(천원)',
        }
