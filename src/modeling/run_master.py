...
def main():
    ...
    parser.add_argument(
        '--config', 
        type=str, 
        default='src/modeling/master_config.json',
    ...
    if args.template:
        template_map = {
            'quick': 'src/modeling/config_templates/quick_test_config.json',
            'production': 'src/modeling/config_templates/production_config.json',
            'lasso': 'src/modeling/config_templates/lasso_focus_config.json'
        }
