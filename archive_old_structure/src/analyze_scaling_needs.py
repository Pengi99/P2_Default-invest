...
fs_ratio = pd.read_csv('data/processed/FS_ratio_flow.csv', dtype={'거래소코드': str})
...
plt.tight_layout()
plt.savefig('data/processed/ratio_distributions.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig('data/processed/ratio_boxplots_normalized.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig('data/processed/scaling_need_indicators.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig('data/processed/scaling_comprehensive_analysis.png', dpi=300, bbox_inches='tight')
plt.show()
...
# Excel 파일로 저장
with pd.ExcelWriter('data/processed/scaling_analysis_detailed.xlsx', engine='openpyxl') as writer:
...
print(f"✅ 상세 분석 결과 저장: data/processed/scaling_analysis_detailed.xlsx")
print(f"✅ 시각화 파일 저장:")
print(f"   - data/processed/ratio_distributions.png")
print(f"   - data/processed/ratio_boxplots_normalized.png")
print(f"   - data/processed/scaling_need_indicators.png")
print(f"   - data/processed/scaling_comprehensive_analysis.png")
